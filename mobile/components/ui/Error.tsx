  ...
  return (
    <View className="flex-1 bg-background">
      <View className="px-6 pb-4 border-b border-black/5 dark:border-white/5 flex-row items-center gap-4" style={{ paddingTop: insets.top + 10 }}>
        ...
        <Text className="text-text-primary text-xl font-bold">Wishlist</Text>
      </View>
      <View className="flex-1 items-center justify-center px-10">
        ...
        <Text className="text-text-secondary text-center mt-2 text-sm opacity-80">
          {subtitle}
        </Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.back()}
        >
          <Text className="text-text-primary font-bold">{buttonTitle}</Text>
        </TouchableOpacity>
        )}
      </View>
    </View>
